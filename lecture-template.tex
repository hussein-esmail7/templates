...
% templateDescription: LaTeX School Course Lecture Notes Document
...
\newcommand{\Prof}					{Course Prof Here} % First only (used for referencing in-document)
...
\newcommand{\myTitle}{\myCourseCode{} \myCourseCredits{}.0: \myCourseTitle{} \\ \myCourseSemester{} - \myCourseSchedule{}}
% =========================== Variables ===========================
