...
\def{\myCourseDateCreated}   {Created Date Here}
\def{\myCourseDateUpdated}   {\today}
\def{\myCourseCredits}       {Credits num}
\def{\myCourseCode}          {Course Code Here}
\def{\myCourseTitle}         {Course Title here}
\def{\myCourseProf}          {Course Prof Here}    % First Last only
\def{\myCourseSemester}      {Year and season here} % Ex. 2019F
\def{\myCourseSchedule}      {Weekdays/Times of Day Here} % Ex. MWF 9:00
\def{\myCourseSection}       {Section Here} % Single letter
...
\usepackage{longtable}	% Used for tables with more capability
