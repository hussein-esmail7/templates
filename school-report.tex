...
% templateDescription: School Report LaTeX Template

% This file can be found at https://github.com/hussein-esmail7/templates

% =========================== Variables ===========================
\newcommand{\myStudentNum}			{}	% TODO: Student number here
\newcommand{\myCourse}				{}	% TODO: Course (+ section if required)
\newcommand{\mySubject}				{}	% TODO: PDF subjects
\newcommand{\myKeywords}			{}	% TODO: PDF keywords, sep. by comma
\newcommand{\myName}				{[AUTHOR]}			% Author of this file
\newcommand{\myDate}				{[DATE]}			% Date on cover page
\newcommand{\myTitle}				{[FILE FRONT]}		% Title on cover page
% =========================== Variables ===========================
